...
<body id="body" data-bs-theme="light">
    <nav class="navbar mb-0 p-2 navbar-expand-lg bg-body-tertiary shadow fixed-top">
        <div class="container-fluid d-flex">
            <img src="images/logo.png" class="logonav" style="max-width: 8%;" alt="narutonav">
            <button class="btnMode text-end p-0 m-0" onclick="changeMode()">
                <img id="light-mode-icon" class="mode-icon p-0" style="max-width: 90%;" src="images/Sun.png" alt="light-mode-icon">
            </button>
        </div>
    </nav>
