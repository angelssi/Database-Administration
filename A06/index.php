...
if (!isset($_COOKIE['email'])) {
  ...
  if (isset($_POST['deletePostID'])) {
      ...
      $result = $conn->query("SELECT u.email FROM users u JOIN posts p ON p.userID = u.userID WHERE p.postID = $deletePostID");
            ...
            <div class="post">
                <div class="d-flex justify-content-between align-items-center mb-0">
                    ...
                    <div>
                        ...
                        <?php if ($post['email'] == $loggedInUser): ?>
                            <button type="button" class="btn-options pt-0 pb-3" style="text-decoration: none; background: none; outline: none; border: none;" data-bs-toggle="dropdown" aria-expanded="false">
                                <h2>...</h2>
                            </button>
